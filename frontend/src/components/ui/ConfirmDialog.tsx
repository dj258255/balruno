      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <h2 id="confirm-dialog-title" className="text-base font-semibold" style={{ color: 'var(--text-primary)' }}>
              {title}
            </h2>
          </div>
          <button
        ...
        {/* 본문 — whitespace-pre-line 으로 \n 반영 */}
        <div className="px-5 py-4">
          <p id="confirm-dialog-msg" className="text-sm whitespace-pre-line" style={{ color: 'var(--text-secondary)' }}>
            {message}
          </p>
        </div>
