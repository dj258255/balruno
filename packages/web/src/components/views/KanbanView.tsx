...
export default function KanbanView({ projectId, sheet }: KanbanViewProps) {
  ...
  const toggleField = (id: string) => {
    ...
    updateSheetMetadata(projectId, sheet.id, { viewKanbanFieldIds: next });
  };
      ...
      <div className="px-4 py-2 border-b flex items-center gap-2 relative" style={{ borderColor: 'var(--border-primary)' }}>
        ...
        <div className="w-48">
          <CustomSelect
            value={groupColId ?? ''}
            onChange={(v) =>
              updateSheetMetadata(projectId, sheet.id, { viewGroupColumnId: v })
            }
        ...
        {showSettings && (
          ...
          >
            ...
            <div className="p-3 border-b" style={{ borderColor: 'var(--border-primary)' }}>
              ...
              <select
                value={coverColId ?? ''}
                onChange={(e) => updateSheetMetadata(projectId, sheet.id, { viewKanbanCoverColumnId: e.target.value || undefined })}
